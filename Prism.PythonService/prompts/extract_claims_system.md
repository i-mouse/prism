...
- **Papers typically yield 15-30 claims once positioning claims are counted alongside empirical ones.** Extracting fewer than 12 is a strong signal you are filtering out positioning claims because they don't have a number attached. Extracting more than 35 means you are including plain implementation details or field-level background that assert nothing about this paper's own method.
